/** User cancelled mid-run: 2 passed, 10 cancelled. */
...
export default {
  title: 'gh-ci-utils/Status/CancelledRun',
  component: CiView,
  argTypes: {
    ...commonArgTypes,
    playbackSpeed: {
  ...
  render: function Render(args) {
    return (
      <TuiStoryPreview
        ...
        {...createInteractiveProps({
          args,
          staticState: createSingleRunState({ jobs: cancelledJobs }),
          idleState: loadingState(),
          createTimeline: () => createCancelledRunTimeline(),
        })}
      />
    )
  },
