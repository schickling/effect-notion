/** Mid-run: 4 builds complete, 8 jobs still in-progress. */
...
export default {
  title: 'gh-ci-utils/Status/InProgress',
  component: CiView,
  argTypes: {
    ...commonArgTypes,
    playbackSpeed: {
  ...
  render: function Render(args) {
    return (
      <TuiStoryPreview
        ...
        {...createInteractiveProps({
          args,
          staticState: createSingleRunState({ jobs: inProgressJobs }),
          idleState: loadingState(),
          createTimeline: () => createInProgressTimeline(),
        })}
      />
    )
  },
